...
<head>
    ...
    <title><?= $title; ?> | Aplikasi Pemesanan Produk</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-gradient-success justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">Pemesanan Produk</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('jenis'); ?>">Jenis Produk</a>
                        <a class="collapse-item" href="<?= base_url('satuan'); ?>">Satuan Produk</a>
    ...
    <script type="text/javascript">
        ...
        let jumlah = hal == 'produkmasuk' ? $('#jumlah_masuk') : $('#jumlah_keluar');

        $(document).on('change', '#produk_id', function() {
            var selectedCustomValue = $("select#produk_id option:selected").attr("data-harga");
            $('input.harga').val(selectedCustomValue);


            //console.log(selectedCustomValue);
            let url = '<?= base_url('produk/getstok/'); ?>' + this.value;
    ...
    <?php if ($this->uri->segment(1) == 'dashboard') : ?>
        ...
        <script type="text/javascript">
            ...
            var myPieChart = new Chart(ctx, {
                type: 'doughnut',
                data: {
                    labels: ["Pembelian", "Pesanan"],
                    datasets: [{
                        data: [<?= $pembelian; ?>, <?= $pemesanan; ?>],
