        ...
        <div class="card shadow-sm border-bottom-primary">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('produkmasuk') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <input value="<?= set_value('tanggal', date('Y-m-d')); ?>" name="tanggal" id="tanggal_masuk" type="text" class="form-control date" placeholder="Tanggal Masuk...">
                        ...
                        <div class="input-group">
                            ...
                            <select name="supplier_id" id="supplier_id" class="custom-select">
                                ...
                                <?php foreach ($supplier as $g) : ?>
                                    <option <?= set_select('supplier_id', $g['id_supplier']) ?> value="<?= $g['id_supplier'] ?>"><?= $g['nama'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="input-group">
                            ...
                            <select name="produk_id" id="produk_id" class="custom-select">
                                ...
                                <?php foreach ($produk as $b) : ?>
                                    <option <?= $this->uri->segment(3) == $b['id_produk'] ? 'selected' : '';  ?> <?= set_select('produk_id', $b['id_produk']) ?> value="<?= $b['id_produk'] ?>"><?= $b['id_produk'] . ' | ' . $b['nama'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="input-group-append">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <input value="<?= set_value('jumlah_masuk'); ?>" name="jumlah" id="jumlah_masuk" type="number" class="form-control" placeholder="Jumlah Masuk...">
                            <div class="input-group-append">
