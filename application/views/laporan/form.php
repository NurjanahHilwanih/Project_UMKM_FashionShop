                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="custom-control custom-radio">
                            <input checked value="pembelian" type="radio" id="pembelian" name="transaksi" class="custom-control-input">
                            <label class="custom-control-label" for="pembelian">Pembelian</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input value="pemesanan" type="radio" id="pemesanan" name="transaksi" class="custom-control-input">
                            <label class="custom-control-label" for="pemesanan">Pesanan</label>
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <select name="konsumen_id" id="konsumen_id" class="custom-select pemesanan">
